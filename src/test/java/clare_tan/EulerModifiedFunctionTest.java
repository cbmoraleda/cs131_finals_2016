...
public class EulerModifiedFunctionTest {
  ...
  public void testOdeModEulerExample() {
    try {
  		...
  		File file = new File(dir + "/src/test/resources/test_files/clare_tan/EulerModifiedFunction.in");
      ...
      for(int k = 0; k < testCases; k++) {
        ...
        double[] result = eulerModFunc.getyValues();
        ...
        assertArrayEquals("Ode modified must past example", expected, actual, threshold);
      }
    } catch (Exception e) {
      e.printStackTrace();
      assertTrue(false);
